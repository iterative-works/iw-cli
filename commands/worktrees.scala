...
@main def worktrees(args: String*): Unit =
  ...
  // Output
  if jsonFlag then println(upickle.default.write(worktreeSummaries))
  else println(WorktreesFormatter.format(worktreeSummaries))
