...
object ProjectDetailsView:
  /** Render project details page with filtered worktree cards.
    ...
    *   List of tuples (worktree, optional issue data, optional progress,
    *   optional git status, optional PR data, optional review state)
    * @param now
  ...
  /** Render a single worktree card.
    ...
    * @param issueData
    *   Optional issue data with cache flag and stale flag
    * @param progress
  ...
  /** Capitalize first letter of tracker type for display.
    *
    * @param trackerType
    *   Tracker type string (e.g., "github", "linear")
    * @return
    *   Capitalized tracker type (e.g., "GitHub", "Linear")
    */
  /** Render a not-found page for an unknown project name.
    *
    * @param projectName
    *   The project name that was requested but not found
    * @return
