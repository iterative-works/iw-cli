...
class MainProjectServiceTest extends FunSuite:
  ...
  test(
    "deriveFromWorktrees with multiple worktrees from same project returns one project"
  ):
  ...
  test(
    "deriveFromWorktrees with multiple worktrees from different projects returns multiple projects"
  ):
    val worktree1 = WorktreeRegistration(
      issueId = "IW-79",
      path = "/home/user/projects/iw-cli-IW-79",
    ...
    def loadConfig(path: os.Path): Either[String, ProjectConfiguration] =
      if path.toString.contains("iw-cli") then Right(configGitHub)
      else Right(configLinear)
  ...
  test(
    "deriveFromWorktrees filters out worktrees without valid issue ID suffix"
  ):
  ...
  test(
    "resolveProjects with no worktrees and no registered projects returns empty list"
  ):
  ...
  test(
    "resolveProjects with worktrees only returns same as deriveFromWorktrees"
  ):
    val worktree = WorktreeRegistration(
      issueId = "IW-79",
      path = "/home/user/projects/iw-cli-IW-79",
    ...
    val derived =
      MainProjectService.deriveFromWorktrees(List(worktree), _ => Right(config))
  ...
  test(
    "resolveProjects with registered projects only (no worktrees) returns registered projects"
  ):
  ...
  test(
    "resolveProjects merges registered and derived projects deduplicating by path"
  ):
    val worktree = WorktreeRegistration(
      issueId = "IW-79",
      path = "/home/user/projects/iw-cli-IW-79",
  ...
  test(
    "resolveProjects registered project at different path appears alongside derived project"
  ):
    val worktree = WorktreeRegistration(
      issueId = "IW-79",
      path = "/home/user/projects/iw-cli-IW-79",
    ...
    val result = MainProjectService.resolveProjects(
      worktrees = List(worktree),
      registeredProjects =
        Map("/home/user/projects/other-project" -> registered),
      loadConfig = _ => Right(config)
    )
