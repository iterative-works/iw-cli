...
class ProjectFilteringTest extends FunSuite:
  ...
  test("filterByProjectName returns empty list when no worktrees match"):
    ...
    val result =
      MainProjectService.filterByProjectName(List(worktree1), "nonexistent")
  ...
  test("filterByProjectName handles multiple projects with similar names"):
    ...
    val result1 = MainProjectService.filterByProjectName(
    ...
    val result2 = MainProjectService.filterByProjectName(
      List(worktree1, worktree2),
      "iw-cli-tools"
    )
  ...
  test("filterByProjectName is case-sensitive on project names"):
    ...
    val result =
      MainProjectService.filterByProjectName(List(worktree), "IW-CLI")
