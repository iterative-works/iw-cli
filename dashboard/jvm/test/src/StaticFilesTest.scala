...
class StaticFilesTest extends FunSuite:
  ...
  test("GET /static/dashboard.css returns file contents"):
    ...
    try
      ...
      assert(
        body.contains(".worktree-card"),
        "CSS should contain .worktree-card class"
      )
  ...
  test("GET /static/dashboard.js returns file contents"):
    ...
    try
      ...
      assert(
        ...
        "JS should contain visibilitychange event"
      )
      assert(
        body.contains("htmx.trigger"),
        "JS should contain htmx.trigger call"
      )
