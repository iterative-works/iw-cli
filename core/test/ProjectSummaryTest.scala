...
class ProjectSummaryTest extends FunSuite:
  ...
  test(
    ...
    val project2 =
      createProject("/home/user/projects/kanon", "kanon", "linear", "IWLE")

    val worktree1 = createWorktree("IW-1", "/home/user/projects/iw-cli-IW-1")
    val worktree2 = createWorktree("IW-2", "/home/user/projects/iw-cli-IW-2")
    val worktree3 = createWorktree(
      "IWLE-1",
      "/home/user/projects/kanon-IWLE-1",
      "linear",
      "IWLE"
    )
    val worktree4 = createWorktree(
      "IWLE-2",
      "/home/user/projects/kanon-IWLE-2",
      "linear",
      "IWLE"
    )
    val worktree5 = createWorktree(
      "IWLE-3",
      "/home/user/projects/kanon-IWLE-3",
      "linear",
      "IWLE"
    )
  ...
  test("computeSummaries excludes worktrees that don't match project pattern"):
    val project = createProject("/home/user/projects/iw-cli", "iw-cli")
    val validWorktree =
      createWorktree("IW-1", "/home/user/projects/iw-cli-IW-1")
    val orphanedWorktree =
      createWorktree("OTHER-1", "/home/user/projects/just-a-directory")
