...
/** Pull request state enumeration. Maps to GitHub (OPEN, MERGED, CLOSED) and
  * GitLab (opened, merged, closed) states.
  */
enum PRState:
...
case class PullRequestData(
  ...
  /** CSS class for PR state badge. Returns "pr-open" for Open, "pr-merged" for
    * Merged, "pr-closed" for Closed.
    */
  ...
  /** Badge text for PR state display. Returns "Open", "Merged", or "Closed".
    */
