...
/** Issue data with URL and fetch timestamp for caching.
  ...
  *   Issue title
  * @param status
  *   Issue status (e.g., "In Progress", "Done")
  * @param assignee
  *   Optional assignee name
  * @param description
  *   Optional issue description
  * @param url
  *   Direct link to issue in tracker (Linear or YouTrack)
  * @param fetchedAt
  *   Timestamp when issue data was fetched from API
  */
...
object IssueData:
  /** Create IssueData from Issue entity with URL and timestamp.
    *
    * @param issue
    *   Issue entity from tracker API
    * @param url
    *   Direct link to issue in tracker
    * @param fetchedAt
    *   Timestamp when issue was fetched
    * @return
    *   IssueData with all fields populated
    */
