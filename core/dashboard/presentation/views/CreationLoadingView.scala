...
object CreationLoadingView:
  /** Render loading state during worktree creation.
    ...
    *
    * HTMX will automatically show/hide this element when requests are in
    * progress by using the htmx-indicator class and matching hx-indicator
    * attribute.
    *
    * @return
    *   HTML fragment for loading state
    */
  def render(): Frag =
    div(
      id := "creation-spinner",
