...
- [x] Phase 3: Frontend pipeline + fat-jar assembly + integration tests (Est: 5-9h) → `phase-03-context.md`
- [x] Phase 4: Command integration + dev mode (Est: 3-5h) → `phase-04-context.md`
