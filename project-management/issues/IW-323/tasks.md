...
- [x] Phase 3: Plugin command execution (Est: 3-5h) → `phase-03-context.md`
- [x] Phase 4: Hooks and version checking (Est: 2-3h) → `phase-04-context.md`
- [x] Phase 5: E2E tests (Est: 5-8h) → `phase-05-context.md`
