...
- [x] Phase 2: phase-merge does not commit review-state.json updates (Est: 1-2h) → `phase-02-context.md`
- [x] Phase 3: phase-advance does not commit review-state.json update (Est: 1-2h) → `phase-03-context.md`
