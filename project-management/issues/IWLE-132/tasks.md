...
- [ ] Phase 1: Initialize project with GitHub tracker (Est: 6-8h) → `phase-01-context.md`
- [ ] Phase 2: Repository auto-detection from git remote (Est: 4-6h) → `phase-02-context.md`
