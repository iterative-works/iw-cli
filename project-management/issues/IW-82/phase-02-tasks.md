...
- [x] [impl] [x] [reviewed] Add 5 WorktreeRegistration samples (IWLE-123, IWLE-456, GH-100, YT-111, YT-222)
...
- [x] [impl] [x] [reviewed] Add 5 IssueData samples with diverse statuses, including one without assignee
...
- [x] [impl] [x] [reviewed] Add 4 ReviewState samples with varying artifacts

**CachedReviewState samples:**
- [x] [test] [x] [reviewed] Test CachedReviewState samples include fresh and stale
- [x] [impl] [x] [reviewed] Add CachedReviewState samples
...
- [x] [impl] [x] [reviewed] Create SampleDataGenerator.scala with generateSampleState() function
...
- [x] [impl] [x] [reviewed] Populate all cache maps in generateSampleState()
...
- [x] [impl] [x] [reviewed] Ensure edge cases are properly represented in generated state
...
- [x] [impl] [x] [reviewed] Add sampleData: Boolean = false parameter to dashboard @main function
...
- [x] [impl] [x] [reviewed] When sampleData=true, call SampleDataGenerator and persist to effectiveStatePath

**Isolation (Phase 1 integration):**
- [ ] [test] Test production path unchanged when --state-path provided with --sample-data
- [x] [impl] [x] [reviewed] Verify state isolation works with sample data
