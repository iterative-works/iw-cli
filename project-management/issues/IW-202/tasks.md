...
- [x] Phase 3: `validate --help` fails with misleading error (Est: 0.5-1h) → `phase-03-context.md`
- [x] Phase 4: `review-state --help` reports "Unknown subcommand" (Est: 0.5-1h) → `phase-04-context.md`
