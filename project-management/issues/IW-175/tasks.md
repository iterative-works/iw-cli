...
- [ ] Phase 1: Stable card positions during auto-refresh (Est: 4-6h) → `phase-01-context.md`
- [ ] Phase 2: New worktrees appear at predictable location (Est: 2-3h) → `phase-02-context.md`
